...

{
...

    {
        ...
        _shellViewModel.Settings.OpenHistoryRequested += (_, _) =>
        ...
        _services.Settings.SettingsChanged += (_, _) => ApplyTheme();
...

    {
        ...
        var runningBar = _shellViewModel.WorkTree.RunningTaskBar;
...

        {
            ...
            if (_shellViewModel.IsCompactOverlay)

            {

                _shellViewModel.Focus.RequestQuickCaptureFocus();
...

            {
                ...
                if (_shellViewModel.CurrentArea != ShellArea.WorkTree)

                {

                    _shellViewModel.NavigateTo(ShellArea.WorkTree);

                }



                _shellViewModel.WorkTree.RequestQuickCaptureFocus();
...

        {
...

            {
                ...
                case Key.N:
                    ...
                    _shellViewModel.EnterCompactOverlay();
                ...
                case Key.P:
                    ...
                    if (runningBar.HasRunningTask)

                    {

                        if (runningBar.IsPaused)

                        {

                            runningBar.ResumeCommand.Execute(null);
...

                        {
                            ...
                            runningBar.PauseCommand.Execute(null);
                ...
                case Key.Enter:
                    ...
                    if (runningBar.MarkDoneCommand.CanExecute(null))

                    {

                        runningBar.MarkDoneCommand.Execute(null);

                    }

                    else if (focus.FinishCommand.CanExecute(null))
                ...
                case Key.M:
                    ...
                    _shellViewModel.ToggleCompactOverlayCommand.Execute(null);
